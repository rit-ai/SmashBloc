...
/*
 * The simplest form of master AI, this one only spawns Twirl units, only 
...
public sealed class PlayerAI_Basic : PlayerAI {
    ...
    private IEnumerator SpawnTwirl()
    {
        while (true)
        {
            ...
            {
                AddCommand(new SpawnUnitCommand(Twirl.IDENTITY, city));
            }
